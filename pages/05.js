...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const init = async () => {
      ...
      scene.add( dirLit )
      const dirLit2 = new THREE.DirectionalLight( 0xffffff, 1 )
      dirLit.rotation.y = 1
      scene.add( dirLit2 )
  ...
  return (
    ...
    <div className={styles.title}>05 - moving background with transparent object and diffused refraction</div>
    </>
  )
}
